...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBusinessException(BusinessException exception) {
        ...
        return buildBusinessError(
                exception, resolveHttpStatus(exception.getErrorCode().category()));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleValidationException(
        ...
        var errors = ValidationErrorMapper.map(exception.getBindingResult().getFieldErrors());

        ErrorBody error = new ErrorBody("VALIDATION_ERROR", "Validation failed", null, errors);
    ...
    public ResponseEntity<ApiResponse<Void>> handleConstraintViolation(
        ...
        ErrorBody error =
                new ErrorBody(
                        "CONSTRAINT_VIOLATION", "Validation failed", exception.getMessage(), null);
    ...
    public ResponseEntity<ApiResponse<Void>> handleException(Exception exception) {
        ...
        ErrorBody error = new ErrorBody("INTERNAL_SERVER_ERROR", "Unexpected error", null, null);
    ...
    private HttpStatus resolveHttpStatus(ErrorCategory category) {
        ...
        return switch (category) {
            ...
            case RESOURCE -> HttpStatus.NOT_FOUND;

            case SECURITY -> HttpStatus.UNAUTHORIZED;
    ...
    private ResponseEntity<ApiResponse<Void>> buildBusinessError(
            BusinessException exception, HttpStatus status) {
        ...
        return ResponseEntity.status(status).body(ResponseFactory.error(error));
    }
}
