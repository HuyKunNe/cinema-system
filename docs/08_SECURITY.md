...
Account, password-reset and client revocation triggers, durable security-event persistence, concurrent refresh hardening and R25.11 closure verification are complete.
