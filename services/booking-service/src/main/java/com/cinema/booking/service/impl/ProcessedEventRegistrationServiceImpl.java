...
public class ProcessedEventRegistrationServiceImpl implements ProcessedEventRegistrationService {
    ...
    public boolean register(
        ...
        if (eventId == null) {
            throw new ValidationException(BookingErrorCode.EVENT_ID_REQUIRED);
        }
        ...
        int insertedRows =
                processedEventRepository.insertIfAbsent(
                        ...
                        eventId.toString(),
                        requireText(consumerName, BookingErrorCode.CONSUMER_NAME_REQUIRED),
                        requireText(eventType, BookingErrorCode.EVENT_TYPE_REQUIRED),
                        requireText(eventVersion, BookingErrorCode.EVENT_VERSION_REQUIRED),
