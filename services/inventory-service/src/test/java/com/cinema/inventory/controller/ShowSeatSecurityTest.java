...
class ShowSeatSecurityTest {
    ...
    @Test
    void getByShowtimeIdShouldBePublic()
            throws Exception {
    ...
    @Test
    void generateShouldReturnUnauthorizedWithoutJwt()
            throws Exception {
    ...
    @Test
    void generateShouldReturnForbiddenWithoutManagePermission()
            throws Exception {
    ...
    @Test
    void generateShouldSucceedWithManagePermission()
            throws Exception {
    ...
    @Test
    void makeUnavailableShouldRequireManagePermission()
            throws Exception {
    ...
    @Test
    void makeAvailableShouldRequireManagePermission()
            throws Exception {
    ...
    @Test
    void holdShouldReturnUnauthorizedWithoutJwt()
            throws Exception {
    ...
    @Test
    void holdShouldReturnForbiddenForUserRole()
            throws Exception {
    ...
    @Test
    void holdShouldSucceedForServiceRole()
            throws Exception {
        ...
        ArgumentCaptor<HoldShowSeatRequest> requestCaptor = ArgumentCaptor.forClass(
                HoldShowSeatRequest.class);

        verify(showSeatService).hold(
                eq(showSeatId),
                requestCaptor.capture());

        HoldShowSeatRequest actualRequest = requestCaptor.getValue();

        assertThat(actualRequest.bookingId())
                .isEqualTo(request.bookingId());
    ...
    @Test
    void bookShouldRequireServiceRole()
            throws Exception {
    ...
    @Test
    void releaseShouldRequireServiceRole()
            throws Exception {
    ...
    @Test
    void spoofedRoleHeadersShouldNotAuthorizeServiceEndpoint()
            throws Exception {
    ...
    @Test
    void spoofedPermissionHeaderShouldNotAuthorizeAdminEndpoint()
            throws Exception {
    ...
    private org.springframework.test.web.servlet.ResultActions performGenerate()
            throws Exception {

        GenerateShowSeatsRequest request = new GenerateShowSeatsRequest(DEFAULT_PRICE);

        return mockMvc.perform(post("/api/v1/show-seats")
                .param(
                        "showtimeId",
                        UUID.randomUUID().toString())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    private HoldShowSeatRequest validHoldRequest() {
        return new HoldShowSeatRequest(
                UUID.randomUUID(),
