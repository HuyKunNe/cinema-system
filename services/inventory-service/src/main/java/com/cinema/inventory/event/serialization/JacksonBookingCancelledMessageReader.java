...
@Component
public class JacksonBookingCancelledMessageReader implements BookingCancelledMessageReader {

    private final ObjectMapper objectMapper;

    public JacksonBookingCancelledMessageReader(ObjectMapper objectMapper) {
