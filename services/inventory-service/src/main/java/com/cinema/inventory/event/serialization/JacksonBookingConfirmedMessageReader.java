...
@Component
public class JacksonBookingConfirmedMessageReader implements BookingConfirmedMessageReader {

    private final ObjectMapper objectMapper;

    public JacksonBookingConfirmedMessageReader(ObjectMapper objectMapper) {
