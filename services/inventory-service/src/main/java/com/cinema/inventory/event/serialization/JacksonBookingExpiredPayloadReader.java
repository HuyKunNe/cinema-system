...
@Component
public class JacksonBookingExpiredPayloadReader implements BookingExpiredPayloadReader {

    private final ObjectMapper objectMapper;

    public JacksonBookingExpiredPayloadReader(ObjectMapper objectMapper) {

        this.objectMapper = objectMapper;
    }

    @Override
    public BookingExpiredPayload read(OutboxEventMessage message) {
        ...
        try {
            return objectMapper.treeToValue(message.payload(), BookingExpiredPayload.class);
