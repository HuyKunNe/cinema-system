...
@Component
public class JacksonSeatReleaseRequestedMessageReader implements SeatReleaseRequestedMessageReader {

    private final ObjectMapper objectMapper;

    public JacksonSeatReleaseRequestedMessageReader(ObjectMapper objectMapper) {
