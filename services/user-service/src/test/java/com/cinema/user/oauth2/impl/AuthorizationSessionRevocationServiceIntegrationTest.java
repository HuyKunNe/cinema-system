...
@Transactional
class AuthorizationSessionRevocationServiceIntegrationTest
    ...
    void shouldRevokeAuthorizationAndHistoryByPrincipalName() {
        ...
        String principalName = "principal-revocation-"
                + suffix
                + "@example.com";
    ...
    void shouldRevokeAuthorizationAndHistoryByRegisteredClientId() {
        ...
        String principalName = "client-revocation-"
                + suffix
                + "@example.com";
    ...
    void repeatedRevocationShouldRemainIdempotent() {
        ...
        String principalName = "idempotent-revocation-"
                + suffix
                + "@example.com";
    ...
    private RegisteredClient saveRegisteredClient(
        ...
        String clientId = "r25-11-8-revocation-"
                + suffix;
