...
class OidcLogoutIntegrationTest
    ...
    private static final String CODE_VERIFIER = "cinema-oidc-logout-pkce-verifier-123456789012345678901";
    ...
    @Test
    void shouldLogoutWithValidIdTokenHint()
            throws Exception {
        ...
        RefreshTokenHistory historyBeforeLogout = refreshTokenHistoryRepository
                .findByTokenHash(
                        refreshTokenHasher.hash(
                                refreshToken))
                .orElseThrow();

        assertThat(historyBeforeLogout.getStatus())
                .isEqualTo(
                        RefreshTokenStatus.ACTIVE);

        assertThat(historyBeforeLogout.getRevokedAt())
                .isNull();
        ...
        RefreshTokenHistory historyAfterLogout = refreshTokenHistoryRepository
                .findByTokenHash(
                        refreshTokenHasher.hash(
                                refreshToken))
                .orElseThrow();

        assertThat(historyAfterLogout.getStatus())
                .isEqualTo(
                        RefreshTokenStatus.REVOKED);

        assertThat(historyAfterLogout.getRevokedAt())
                .isNotNull();
    ...
    private User createActiveUser() {
        return executeInTransaction(() -> {
            ...
            String email = "oidc.logout."
                    + suffix
                    + "@example.com";

            String username = "oidc.logout."
                    + suffix;
    ...
    private String authorize(
        ...
        String authorizationCode = redirect
                .getQueryParams()
                .getFirst(
                        "code");
