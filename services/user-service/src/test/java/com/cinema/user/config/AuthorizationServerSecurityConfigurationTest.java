...
class AuthorizationServerSecurityConfigurationTest extends AbstractMySqlIntegrationTest {
    ...
    @Test
    void authorizationEndpointShouldBeHandledByAuthorizationServerChain() throws Exception {

        mockMvc.perform(get("/oauth2/authorize")).andExpect(status().isBadRequest());
    }

    @Test
    void loginPageShouldBeAvailable() throws Exception {
    ...
    @Test
    void protectedApplicationEndpointShouldRedirectToLogin() throws Exception {
    ...
    @Test
    void authorizationServerMetadataShouldExposeCanonicalIssuer() throws Exception {
    ...
    @Test
    void tokenEndpointShouldReturnOAuthErrorForInvalidRequest() throws Exception {
    ...
    @Test
    void oidcProviderConfigurationShouldExposeLogoutEndpoint() throws Exception {
    ...
    void shouldUseJpaUserDetailsService() {
        assertThat(userDetailsService)
                .isInstanceOf(com.cinema.user.security.JpaUserDetailsService.class);
    }

    @Test
    void tokenEndpointShouldAllowSwaggerCorsPreflight() throws Exception {
