...
class PaymentSecurityConfigTest {
    ...
    @Test
    void shouldLoadPaymentSecurityFilterChain() {
    ...
    @Test
    void shouldMapPaymentReadPermissionWithoutScopePrefix() {
        ...
        assertThat(authentication.getAuthorities())
                ...
                .containsExactlyInAnyOrder("ROLE_USER", "payment:read");
    }
    ...
    private Jwt jwt() {
        ...
        return Jwt.withTokenValue("test-token")
                ...
                .claim("permissions", List.of("payment:read"))
                .build();
    }
}
